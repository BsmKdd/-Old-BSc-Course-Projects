<?php
    ...
    if(!empty($_GET['param1']))
    {
        ...
        INNER JOIN workoutmoves AS wm ON mo.id = wm.moveID
        INNER JOIN workouts w ON w.workoutID = wm.workoutID
        INNER JOIN currentworkouts cw ON cw.workoutID = w.workoutID
